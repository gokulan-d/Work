...
console.log("getcontacts" ,page_number);             // var _this = this;
				    ...
				    method					: 'GET'
				  	...
				  	function (err, res) {
						var total_pages;
				  		...
				  		if(curr_data.total_pages > 10){
				  			total_pages = 10;
				  		}else{
				  			total_pages = curr_data.total_pages;
				  		}
				  		

				  		console.log("current iteration:"+ page_number + '=' + total_pages);
